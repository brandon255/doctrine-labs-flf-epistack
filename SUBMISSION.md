...
This tool is one slice of Core OS, the local-first system I build, with a vault, an integrity ledger, and a human approval gate. The genealogy layer is the part that keeps one source from counting as many.
